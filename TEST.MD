...
findOne(): Retrieves a single document that matches the query criteria, returning the first match it finds. 
find(): Retrieves all documents that match the query criteria, returning an array of results.
